...
const translations = {
  en: {
    ...
    metric_requires_attention: "Needs intervention",
    ...
    alert_critical_action: "High Risk Players",
    ...
    players_none_desc: "No results for your search. Try a different name or position, or add a new player to the squad.",
    ...
    login_subtitle: "Access your command center.",
    login_button: "Log in",
  ...
  it: {
    ...
    metric_requires_attention: "Richiede intervento",
    ...
    alert_critical_action: "Giocatori ad Alto Rischio",
    ...
    players_none_desc: "Nessun risultato. Prova con un nome o ruolo diverso, o aggiungi un nuovo giocatore alla rosa.",
    ...
    btn_record_video: "Registra Video",
    btn_import_video: "Importa Video",
    ...
    login_subtitle: "Accedi al tuo centro di comando.",
    login_button: "Accedi",
  ...
  es: {
    ...
    metric_requires_attention: "Requiere intervención",
    ...
    alert_critical_action: "Jugadores de Alto Riesgo",
    ...
    players_none_desc: "Sin resultados. Prueba con un nombre o posición diferente, o añade un nuevo jugador.",
    ...
    btn_import_video: "Importar Video",
    ...
    login_subtitle: "Accede a tu centro de mando.",
  ...
  pt: {
    ...
    metric_requires_attention: "Requer intervenção",
    ...
    alert_critical_action: "Jogadores de Alto Risco",
    ...
    players_none_desc: "Sem resultados. Tenta um nome ou posição diferente, ou adiciona um novo jogador ao plantel.",
    ...
    btn_import_video: "Importar Vídeo",
    ...
    login_subtitle: "Acede ao teu centro de comando.",
    login_button: "Entrar",
